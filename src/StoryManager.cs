...
namespace TEZXANDVENTURE // Note: actual namespace depends on the project name.
{
    internal class Prologue
    {
        ...
        static void ScrollingTextSource_01()
        {
            ...
            Console.WriteLine("");
            Console.WriteLine("Groggily rising, you find yourself wearing tattered remnants of a prison outfit.");
            Thread.Sleep(animationSpeed);
            Console.WriteLine("");
            Console.WriteLine("Chains rattle as you take your first uncertain steps, and muted sunlight filters through a small, barred window, \ncasting a melancholic glow");
            Thread.Sleep(animationSpeed);
            Console.WriteLine("");
            Console.WriteLine("This is where your journey begins, in the somber confines of a place concealing secrets waiting to unfold. ");
            Thread.Sleep(animationSpeed);
            Console.WriteLine("");
        ...
        static void ScrollingTextSource_02()
        {
            ...
            Thread.Sleep(animationSpeed);
            Console.WriteLine("");
            Console.WriteLine("Clutched in its hand is a key – a glimmer of hope in the oppressive darkness. Retrieving the key, you unlock the cell door, \nthe metallic creaking echoing through the hollow corridors.");
            Thread.Sleep(animationSpeed);
            Console.WriteLine("");
